...
%  to convert each email into a vector of features. We will
...
%  Now that we've trained the spam classifier, we can use it on your own emails.
%  The following code reads in one of the emails and then uses 
